...
namespace ns3
{
	...
	*/
	unsigned char NetStreamStorage::readChar() throw()
	{
		if ( !valid_pos() )
		{
	...
	*/
	int_fast64_t NetStreamStorage::readVarint()	throw()
	{
	...
	*
	*/
	void NetStreamStorage::writeVarint(int_fast64_t value) throw()
	{
	...
	*/
	uint_fast64_t NetStreamStorage::readUnsignedVarint()	throw()
	{
		// TODO
		return 0;
	}
...
/*
	...
	*/
	int NetStreamStorage::readByte()	throw()
	{
	...
	*
	*/
	void NetStreamStorage::writeByte(int value) throw()
	{
	...
	*/
	int NetStreamStorage::readUnsignedByte()	throw()
	{
	...
	*
	*/
	void NetStreamStorage::writeUnsignedByte(int value) throw()
	{
	...
	*/
	std::string NetStreamStorage::readString() throw()
	{
		int len = readInt();
		checkReadSafe(len);
	...
	* @return The read string
	*/
	std::vector<std::string> NetStreamStorage::readStringList() throw()
	{
	...
	*/
	int NetStreamStorage::readShort() throw()
	{
		short value = 0;
	...
	// ----------------------------------------------------------------------
	void NetStreamStorage::writeShort( int value ) throw()
	{
	...
	*/
	int NetStreamStorage::readInt() throw()
	{
		int value = 0;
		unsigned char *p_value = reinterpret_cast<unsigned char*>(&value);
	...
	*/
	long NetStreamStorage::readLong() throw()
	{
		long value = 0L;
		unsigned char *p_value = reinterpret_cast<unsigned char*>(&value);
	...
	*/
	float NetStreamStorage::readFloat() throw()
	{
		float value = 0;
		unsigned char *p_value = reinterpret_cast<unsigned char*>(&value);
		readByEndianess(p_value, 4);
	...
	// ----------------------------------------------------------------------
	double NetStreamStorage::readDouble( ) throw ()
	{
		double value = 0;
		unsigned char *p_value = reinterpret_cast<unsigned char*>(&value);
		readByEndianess(p_value, 8);
	...
	// ----------------------------------------------------------------------
	void NetStreamStorage::checkReadSafe(unsigned int num) const  throw()
	{
